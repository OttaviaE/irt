...
<!-- <h3 style="text-align:center;"> PRM </h3> -->

<!-- ```{r} -->
<!-- d1 <- data.frame(prm$coefficients) -->
<!-- for (i in 1:ncol(d1)) { -->
<!--   d1[,i] <- round(d1[,i], 2) -->
<!-- } -->
<!-- kable(d1) -->
...
<!-- <h3 style="text-align:center;"> PCM </h3> -->

<!-- ```{r} -->
<!-- d2 <- data.frame(pcm$coefficients) -->
<!-- for (i in 1:ncol(d2)) { -->
<!--   d2[,i] <- round(d2[,i], 2) -->
<!-- } -->
<!-- kable(d2) -->
...
<!-- <h3 style="text-align:center;"> GRM </h3> -->

<!-- ```{r} -->
<!-- d3 <- data.frame(grm$coefficients) -->
<!-- for (i in 1:ncol(d3)) { -->
<!--   d3[,i] <- round(d3[,i], 2) -->
<!-- } -->
<!-- kable(d3) -->
